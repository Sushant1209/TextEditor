...
class TextEditor implements ActionListener {
    ...
    TextEditor(){
        ...
        //help menu
        linkedln = new JMenuItem("Linkedln Profile");
        help.add(linkedln);
        ...
        linkedln.addActionListener(this); //help option
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        //help section (It opens the Linkedln profile)
        if (e.getSource()==linkedln){
            try {
                String url = "https://www.linkedin.com/in/sushant-bagul";
